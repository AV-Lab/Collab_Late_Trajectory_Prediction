...
class RNNPredictor:    
    ...
    def evaluate(self, loader):
        ...
        if not self.model_trained:
            print("You have to load model form checkpoint or run training to execute evaluation")
            exit
    ...
    def predict(self, obs_tensors):
        ...
        if not self.model_trained:
            print("You have to load model form checkpoint or run training to execute predict")
            exit
